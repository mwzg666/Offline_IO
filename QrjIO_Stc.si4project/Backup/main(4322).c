...
#define STATUS_MASK 0x1FF8   //0x3FFC     // 能远程控制的IO值1
#define MODE_MASK    0x01F8    //0x00FC    // 能闪烁的IO值1
...
//   Bump_ONOFF(0);
   ...
   OutCtl(0,BIT_LED_RED);
   OutCtl(0,BIT_LED_YELLOW);
   OutCtl(0,BIT_LED_GREEN);
   OutCtl(0,BIT_LIGHT_RED);
   OutCtl(0,BIT_LIGHT_YELLOW);
...
void test(void)
{
    OutCtl(1, BIT_ALARM_SOUND);
    OutCtl(1, BIT_LIGHT_RED);
    OutCtl(1, BIT_LIGHT_YELLOW);
    OutCtl(1, BIT_BUMP);
}
*/
